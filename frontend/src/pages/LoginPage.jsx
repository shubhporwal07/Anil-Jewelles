...
export default function LoginPage({ onAdminLogin }) {
  ...
  return (
    <div className="min-h-screen w-full bg-white flex flex-col font-sans">
      <header className="relative z-10 bg-white/85 backdrop-blur-md border-b border-black/5">
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 md:py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 text-xl md:text-2xl font-light tracking-[0.3em] text-slate-900">
      ...
      <main className="flex-1 flex p-0">
        <div className="w-full flex-1 bg-white overflow-hidden flex flex-col md:flex-row min-h-full">
          ...
          <div className="relative w-full md:w-[47%] bg-slate-50 hidden md:block">
            ...
            {/* Better overlay */}
            <div className="absolute inset-0 bg-gradient-to-t from-[#f8f2e9]/90 via-[#f8f2e9]/50 to-transparent"></div>
          ...
          {/* Right Side - Form */}
          <div
            className="relative w-full md:w-[53%] min-h-[calc(100vh-65px)] md:min-h-0 p-5 sm:p-8 lg:p-12 flex items-center justify-center bg-[#fdfcf9] md:rounded-tl-[36px] md:rounded-bl-[36px] shadow-[-10px_0_35px_rgba(15,23,42,0.08)]"
            style={{
              backgroundImage:
                'radial-gradient(circle at 24px 24px, rgba(181,149,81,0.08) 1px, transparent 1px), linear-gradient(135deg, rgba(181,149,81,0.08) 0%, rgba(255,255,255,0) 42%)',
              backgroundSize: '38px 38px, cover',
            }}
          >
            <div className="w-full max-w-[512px] rounded-2xl border border-gray-100 bg-white p-6 sm:p-8 lg:p-9 shadow-[0_18px_55px_rgba(15,23,42,0.12)]">
              <div className="flex w-full mb-7 border-b border-gray-200">
                <button
                  onClick={() => {
                    setIsSignup(false);
                    setErrors({});
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`block w-full pl-10 pr-3 py-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-[#b59551] focus:border-[#b59551] sm:text-sm transition ${errors.email ? 'border-red-500' : 'border-gray-200'}`}
                      disabled={loading}
                    />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className={`block w-full pl-10 pr-10 py-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-[#b59551] focus:border-[#b59551] sm:text-sm transition ${errors.password ? 'border-red-500' : 'border-gray-200'}`}
                      disabled={loading}
                    />
                    <button
                      type="button"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="••••••••"
                        className={`block w-full pl-10 pr-10 py-2 border rounded-lg focus:outline-none focus:ring-1 focus:ring-[#b59551] focus:border-[#b59551] sm:text-sm transition ${errors.confirmPassword ? 'border-red-500' : 'border-gray-200'}`}
                        disabled={loading}
                      />
                      <button
                        type="button"
                  ...
                  <>
                    <div className="relative my-4">
                      ...
                      <div className="relative flex justify-center text-xs">
                        <span className="px-4 bg-white text-[#b59551] font-medium">OR</span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-3">
                      <button
                        ...
                        disabled={loading}
                        className="flex min-h-10 items-center justify-center gap-2 py-2 px-4 border border-gray-200 rounded-md hover:bg-gray-50 transition text-xs font-medium text-slate-700 disabled:opacity-50"
                      >
